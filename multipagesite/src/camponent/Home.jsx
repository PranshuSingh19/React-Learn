              ...
              <div className="col-lg-7">
                <div className="d-flex align-items-center">
                  <img
                    ...
                    src="./assets/img/attachment-img.jpg"
                    style={{
                      height: "100px",
                      width: "100px",
                    }}
  ...
  <div className="container-fluid blog py-5">
    <div className="container py-5">
      <div
        ...
        <h1 className="display-5 text-capitalize mb-3">
          Cental
          <span className="text-primary"> Blog & News</span>
        </h1>
        <p className="mb-0">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet nemo
          expedita asperiores commodi accusantium at cum harum, excepturi, quia
        ...
        <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
          <div className="blog-item">
            ...
            <div className="blog-content rounded-bottom p-4">
              ...
              <a className="h4 d-block mb-3" href="#">
  ...
  <div className="container-fluid team pb-5">
    <div className="container pb-5">
      <div
        ...
        <h1 className="display-5 text-capitalize mb-3">
          Customer
          <span className="text-primary"> Suport</span> Center
        </h1>
        <p className="mb-0">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet nemo
          expedita asperiores commodi accusantium at cum harum, excepturi, quia
  ...
  <div className="container-fluid testimonial pb-5">
    <div className="container pb-5">
      <div
        ...
        <h1 className="display-5 text-capitalize mb-3">
          Our Clients
          <span className="text-primary"> Riviews</span>
        </h1>
        <p className="mb-0">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet nemo
          expedita asperiores commodi accusantium at cum harum, excepturi, quia
